...
export async function submitCheckoutFormData(prevState, formData) {
  ...
  const formValues = {
    ...
    postalCode: prevState?.data?.postalCode || formData.get("postalCode"),
    city: prevState?.data?.city || formData.get("city"),
    line1: prevState?.data?.line1 || formData.get("line1"),
  };
